<template>
	<div class="profile-container w-full pt-2">
		<div class="profile-header">
			...
			<div class="profile-header-info">
				...
				<p
					v-else
					class="profile-email text-orange-400">
					Temporary account without email and registration.
				</p>
			</div>
		</div>
					...
					<div class="flex flex-col gap-3">
						...
						<div
							...
							<div
								...
								<i
									:class="
										rule.valid ? 'pi pi-check-circle' : 'pi pi-circle'
									"></i>
								{{ rule.label }}
							</div>
							<div
								...
								<i
									:class="
										passwordsMatch ? 'pi pi-check-circle' : 'pi pi-circle'
									"></i>
								Passwords match
							</div>
						</div>
		...
		<template v-else>
			<div
				class="profile-section flex flex-col items-center text-center py-2 px-2">
				<h4
					style="
				...
				<div
					class="mb-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-full font-semibold text-sm"
					style="
...
// Obserwowanie zmiany widoczności dla celów czyszczenia pól (zamiast zdarzenia @hide)
watch(
	() => props.isVisible,
	(val) => {
		if (val) {
